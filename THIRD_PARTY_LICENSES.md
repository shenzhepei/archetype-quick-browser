...
Generated from the locked Cargo dependency graph. Regenerate with `cargo run -p arch-browser --example update_license_inventory`.
...
| `gpui-component` | `0.5.1` | `Apache-2.0` | <https://github.com/longbridge/gpui-component> |
| `gpui-component-assets` | `0.5.1` | `Apache-2.0` | <https://github.com/longbridge/gpui-component> |
| `gpui-component-macros` | `0.5.1` | `Apache-2.0` | <https://crates.io/crates/gpui-component-macros/0.5.1> |
| `gpui-macros` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui-macros/0.2.2> |
| `gpui_collections` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui_collections/0.2.2> |
| `gpui_derive_refineable` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui_derive_refineable/0.2.2> |
| `gpui_http_client` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui_http_client/0.2.2> |
| `gpui_media` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui_media/0.2.2> |
| `gpui_perf` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui_perf/0.2.2> |
| `gpui_refineable` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui_refineable/0.2.2> |
| `gpui_semantic_version` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui_semantic_version/0.2.2> |
| `gpui_sum_tree` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui_sum_tree/0.2.2> |
| `gpui_util` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui_util/0.2.2> |
| `gpui_util_macros` | `0.2.2` | `Apache-2.0` | <https://crates.io/crates/gpui_util_macros/0.2.2> |
...
| `markup5ever_rcdom` | `0.35.0+unofficial` | `MIT OR Apache-2.0` | <https://github.com/servo/html5ever> |
...
| `tao-core-video-sys` | `0.2.0` | `MIT` | <https://crates.io/crates/tao-core-video-sys/0.2.0> |
...
| `value-bag-serde1` | `1.13.2` | `Apache-2.0 OR MIT` | <https://crates.io/crates/value-bag-serde1/1.13.2> |
| `value-bag-sval2` | `1.13.2` | `Apache-2.0 OR MIT` | <https://crates.io/crates/value-bag-sval2/1.13.2> |
...
| `workspace-hack` | `0.1.0` | `CC0-1.0` | <https://github.com/facebookincubator/cargo-guppy> |
...
| `xml5ever` | `0.35.0` | `MIT OR Apache-2.0` | <https://github.com/servo/html5ever> |
...
| `zed-sum-tree` | `0.2.0` | `Apache-2.0` | <https://crates.io/crates/zed-sum-tree/0.2.0> |
...
| `zvariant` | `5.14.0` | `MIT` | <https://github.com/z-galaxy/zbus/> |
| `zvariant_derive` | `5.14.0` | `MIT` | <https://github.com/z-galaxy/zbus/> |
